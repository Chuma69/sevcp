...
// Fuller descriptions shown in each finalist's expanded view (2–3 sentences).
const FINALIST_ABOUT = {
  'Ije Rides':'Ije Rides is a multimodal mobility aggregation platform integrating road and water transport across South East Nigeria. It formalises informal transport through digital booking, cashless payments and trip tracking — starting with a pilot in Onitsha — using an asset-light model that partners with existing operators to create more stable incomes.',
  'Solala Energy':'Solala builds technology that makes solar site assessment fast, remote and data-driven. Instead of days of site visits, its platform lets installers analyse rooftops, size systems and generate accurate solar proposals from anywhere — cutting cost and time so solar companies can scale faster.',
  'CAMS':'CAMS (Credit Automated Management System) is digital credit infrastructure connecting verified borrowers to licensed lenders through a structured marketplace, with repayments automated through payroll and other trusted anchor institutions. Rather than lending directly, it verifies income, enforces repayment limits and reduces default risk to enable safe, scalable lending across the formal and informal sectors.',
  'Scaloo':'Scaloo is a performance-based distribution network of human advocates embedded in local communities who share the realities of the customers brands want to reach, lowering the trust barrier that digital channels cannot cross. Its AI platform handles onboarding, briefing, payments and performance tracking across the network in real time.',
  'Azubatech':'Azubatech is a simple, POS-like tool that helps small businesses and traders manage sales, inventory and receivables without accounting knowledge. It converts everyday business data into a Bankability Score reflecting profitability, cash flow and debt management — turning informal transactions into verifiable data so lenders can assess small businesses and traders can access growth capital.',
  'Izifin':'Izifin enables hospitals to offer patients instant financing at the point of care by connecting them to lenders through embedded financial infrastructure.',
  'JUMPA':'Jumpa is an automated payments platform for cross-border transfers, stablecoin on/off-ramps and virtual USD accounts. It lets users spend stablecoins like cash — no local bank account needed — converting and routing payments to merchants’ local bank accounts across 70+ countries, with a conversational interface for everyday money movement.',
  'Prepmewell':'Prepmewell is an EdTech ecosystem powering the upward mobility of Nigerian talent — from IELTS preparation to indigenous and foreign language programs. It is now scaling with Prepmewell JAMB, an AI-driven solution built to replace the stress of exam repetition with first-time success.',
  'OneGrid Energies':'OneGrid recycles waste plastic bottles and e-waste from discarded laptop batteries into low-cost solar rechargeable lanterns for rural communities. Users recharge them for a fee at cloud-based solar charging stations managed by rural women, creating jobs and empowerment.',
  'VoteNaija':'VoteNaija is a monetised digital voting platform that lets event organisers host transparent, paid contests with real-time results and instant payments. Since launching in June 2025 it has onboarded 200+ organisers, hosted 150+ events and processed over ₦29m in transactions organically.',
  'Kredo':'Kredo is a verified work-identity platform for African freelancers. A freelancer logs a completed gig, the actual client confirms it, and the result is a portable, client-confirmed Work ID they can share anywhere — not self-reported and not tied to any platform. It is live with early users across Nigeria and Ghana.',
  'Kitovu Technology Company':'Kitovu is an agri-tech and farming-infrastructure company that helps smallholder farmers become more productive, financeable and market-connected. It combines AI advisory (YieldMax), storage and warehouse-receipt financing (StorageX) and supply-chain and trade financing (eProcure), delivered through Farmer Service Centres and a network of field partners.',
  'NotedMark AI':'NotedMark AI builds data infrastructure for physical AI — helping companies collect, label and manage real-world data for computer vision, robotics and autonomous tools. It turns messy, unstructured data from real environments into high-quality datasets across sectors like agriculture, logistics and security in Africa.',
  'llava':'llava is an AI legal associate that automates manual, repetitive legal processes like document drafting, helping lawyers save time and increase revenue.',
  'AgriPulse AI':'AgriPulse AI is an AI-powered agricultural-intelligence platform that gives smallholder farmers data-driven insights to improve productivity, reduce losses and access better markets. It aggregates weather, soil, satellite and market data into real-time, localised recommendations on crop planning, health and pricing, and links farmers directly to buyers.',
  'Trashverse Recycling Technology':'Trashverse is a climate-tech platform transforming waste management in Abia State through a digital, incentive-driven model. Households and businesses exchange recyclable waste for rewards and are connected to collectors and recycling partners. Its MVP has generated over ₦1m in three months, supplying 4,000kg of plastics to a local recycler.',
  'Atuzor':'Atuzor is building compliance infrastructure for African businesses.',
  'Inspectra':'Inspectra is a property-technology platform that helps property seekers find trusted properties through verified real-estate professionals.',
  'Fitness Space':'Fitness Space is a mobile weight-loss app that helps people lose weight and build sustainable habits through a structured, community-driven system. Its AI nutrition coach, Bibi, suggests culturally appropriate meals and scores them, combining meal planning, intermittent fasting and activity tracking with a health score that rewards consistency with real subscription discounts.',
  'Orbyt':'Orbyt is a social event operating system for campuses. It helps hosts and crews create, promote and monetise events, and helps students decide which events to attend — combining event tools, social-graph mechanics, AI priority ranking, ticketing and academic integration in one system.',
  'Gethelpa':'Gethelpa is a CareTech platform building a structured ecosystem for caregivers, connecting households with verified, trained domestic staff. It replaces unsafe, informal hiring with field verification, training (Academy), recruiters and job matching in one system.',
  'Whipcare':'Whipcare is the operating system for vehicle service in Africa, helping vehicle owners and fleets with predictive maintenance and connecting them with trusted vehicle-care experts.',
  'Mionia Technologies':'Mionia engineers climate-hardened energy infrastructure for Africa, combining automotive-grade hardware with intelligent software. Its flagship PowerBox is built for tropical conditions with onboard autonomy that triples typical battery lifespan, making energy assets bankable — with a roadmap toward a networked virtual power plant. It has 40+ paid preorders and live units in the field.',
  'Healthdocx':'Healthdocx consolidates fragmented health data from paper records and siloed EHRs into a single accessible repository. It digitises messy records, converts them into structured, interoperable data (FHIR) and provides the infrastructure that connects health systems and institutions.',
  'Y-Queue':'Y-Queue helps restaurants manage orders, payments and delivery across online and offline channels from a single platform, replacing fragmented tools like WhatsApp, manual processes and disconnected POS systems. It combines order-management software, a demand-generation marketplace and integrated POS hardware. In beta, 55 restaurants have processed over 40,000 orders and ₦60m+ in GMV.'
};
Object.keys(FINALISTS_EXTRA).forEach(y => FINALISTS_EXTRA[y].forEach(f => { f.about = FINALIST_ABOUT[f.name] || f.blurb; }));
